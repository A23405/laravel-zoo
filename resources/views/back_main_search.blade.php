    ...
    <div class="container-fluid direction-column px-0">
        <nav class="navbar navbar-expand-lg bg-light p-3">
            <div class="container-fluid">
                                    ...
                                    <div class="row flex-row" id="top">
                                        ...
                                        <div class="col-6" id="right">
                                            <div class="input-group input-group-sm mb-3">
                                                <span class="input-group-text" id="inputGroup-sizing-sm">門</span>
                                            ...
                                            <div class="input-group input-group-sm mb-3">
                                                ...
                                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="class_" />
                                            </div>
                                            <div class="input-group input-group-sm mb-3">
                ...
                <form class="d-flex" role="search" action="/back_main_search">
                    <input class="form-control me-2" type="search" placeholder="可使用關鍵字查詢" aria-label="Search" name="keyname" />
                        ...
                        <div class="card mt-3" style="background-color:#E6E6F2;">
                            ...
                            <div class="row mb-2">
                                <div class="col-12 d-flex justify-content-center">
                                    ...
                                    <div class="modal fade" id="mainModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content row justify-content-center">
                                                ...
                                                <div class="modal-body row justify-content-center">
                                                    <form class="col-12 d-flex flex-column" id="popDiv" method="post" action="api/speciesarchives/{{$species->id}}" Enctype="Multipart/Form-Data">
                                                        @method('PATCH')
                                                        <div class="row flex-row" id="top">
                                                            <div class="col-6 d-flex justify-content-center" id="left">
                                                                <div class="row direction-column justify-content-center">
                                                                    <div class="col-12 px-1" id="picture">
                                                                        <!--預覽區塊-->
                                                                        <img src="{{$species->img}}" class="img-thumbnail" id="demo1" />
                                                                    </div>
                                                                    <div class="col-12 d-flex justify-content-center mt-4 px-1">
                                                                        <label for="file-upload1" class="custom-file-upload">
                                                                            <i class="fa fa-cloud-upload"></i> 上傳檔案
                                                                        </label>
                                                                        <input id="file-upload1" type="file" name="img" />
                                                                    </div>
                                                                    <div class="input-group input-group-sm mt-auto mb-3 py-4">
                                                                        <span class="input-group-text" id="inputGroup-sizing-sm">俗稱</span>
                                                                        <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="name" value="{{$species->name}}" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-6" id="right">
                                                                <div class="input-group input-group-sm mb-3">
                                                                    <span class="input-group-text" id="inputGroup-sizing-sm">門</span>
                                                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="phylum_" value="{{$species->phylum_}}" />
                                                                </div>
                                                                <div class="input-group input-group-sm mb-3">
                                                                    <span class="input-group-text" id="inputGroup-sizing-sm">綱</span>
                                                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="class_" value="{{$species->class_}}" />
                                                                </div>
                                                                <div class="input-group input-group-sm mb-3">
                                                                    <span class="input-group-text" id="inputGroup-sizing-sm">目</span>
                                                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="order_" value="{{$species->order_}}" />
                                                                </div>
                                                                <div class="input-group input-group-sm mb-3">
                                                                    <span class="input-group-text" id="inputGroup-sizing-sm">科</span>
                                                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="family_" value="{{$species->family_}}" />
                                                                </div>
                                                                <div class="input-group input-group-sm mb-3">
                                                                    <span class="input-group-text" id="inputGroup-sizing-sm">屬</span>
                                                                    <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="genus_" value="{{$species->genus_}}" />
                                                                </div>
                                                                <select class="form-select mb-3" aria-label="Default select example" name="conservation_level">

                                                                    <option selected>{{$species->conservation_level}}</option>
                                                                    <option value="EX">滅絕（Extinct, EX）</option>
                                                                    <option value="EW">
                                                                        野外滅絕（Extinct In the Wild, EW）
                                                                    </option>
                                                                ...
                                                                <select class="form-select mb-3" aria-label="Default select example" name="area">
                                                                    <option selected>{{$species->area}}</option>
                                                                    <option value="亞洲動物區">亞洲動物區</option>
                                                                    <option value="非洲動物區">非洲動物區</option>
                                                                    <option value="澳洲動物區">澳洲動物區</option>
                                                                    <option value="非洲動物區">非洲動物區</option>
                                                        ...
                                                        <div class="row" id=" bottom">
                                                            <div class="input-group input-group-sm mb-3">
                                                                <span class="input-group-text" id="inputGroup-sizing-sm">物種</span>
                                                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="species_" value="{{$species->species_}}" />
                                                            </div>
                                                            <div class="input-group input-group-sm mb-3">
                                                                <span class="input-group-text" id="inputGroup-sizing-sm">體型</span>
                                                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="body_type" value="{{$species->body_type}}" />
                                                            </div>
                                                            <div class="input-group input-group-sm mb-3">
                                                                <span class="input-group-text" id="inputGroup-sizing-sm">學名</span>
                                                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="scientific_name" value="{{$species->scientific_name}}" />
                                                            </div>
                                                            <div class="input-group input-group-sm mb-3">
                                                                <span class="input-group-text" id="inputGroup-sizing-sm">食性</span>
                                                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="feeding_habits" value="{{$species->feeding_habits}}" />
                                                            </div>
                                                            <div class="input-group input-group-sm mb-3">
                                                                <span class="input-group-text" id="inputGroup-sizing-sm">分布</span>
                                                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="distribution" value="{{$species->distribution}}" />
                                                            </div>
                                                            <div class="input-group input-group-sm mb-3">
                                                                <span class="input-group-text" id="inputGroup-sizing-sm">特徵</span>
                                                                <input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="feature" value="{{$species->feature}}" />
                                                            </div>
                                                        </div>
                                                        <div class="row justify-content-around">
                                                            <input value="close" class="btn btn-secondary col-4" data-bs-dismiss="modal">
                                    ...
                                    <form action="api/speciesarchives/{{$species->id}}" method="post">
                                        @method('DELETE')
                                        <input type="submit" class="btn btn-danger mx-1" value="刪除">
                                    </form>
                                </div>
                            </div>
                        </div>
