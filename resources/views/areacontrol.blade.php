...
<head>
    ...
    <!-- http://127.0.0.1:5500/sidebars/areacontrol.html -->

    <!-- Bootstrap core CSS -->
    <link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet" />
    <link rel="styleshet" href="breed_male.css" />
    <link rel="styleshet" href="sidebars.css" />
...
<body>
    ...
    <main>
        <div class="container-fluid d-flex flex-row px-0 justify-content-start">
            <div class="flex-shrink-0 p-3" id="sidebar">
                <div class="col-12 d-flex direction-row justify-content-between my-2">
                    <span class="fs-5 fw-semibold">動物園管理系統</span>
                </div>
                <hr />
                <ul class="list-unstyled ps-0">
                    ...
                    <li class="mb-1">
                        <button class="btn btn-toggle align-items-center rounded collapsed down" data-bs-toggle="collapse" data-bs-target="#dashboard-collapse" aria-expanded="false">
                            健康紀錄
                        </button>
                        <div class="collapse" id="dashboard-collapse">
                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                <li>
                                    <a href="allhealth.html" class="link-dark rounded">個別紀錄</a>
                                </li>
                                <li>
                                    <a href="hospital.html" class="link-dark rounded">就醫紀錄</a>
                                </li>
                            </ul>
                        </div>
                    </li>
